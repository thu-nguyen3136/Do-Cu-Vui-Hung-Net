          ...
          <div className="grid grid-cols-1 lg:grid-cols-4 gap-8 md:gap-10 items-start">
            ...
            <article className="lg:col-span-3 bg-white p-6 md:p-10 rounded-3xl shadow-sm border border-gray-100 overflow-hidden">
              ...
              <div className="prose prose-lg max-w-none text-gray-700 leading-relaxed text-justify mb-10 space-y-4">
                <p>
                  Bạn cần thanh lý bàn ghế cũ do ngừng kinh doanh, đổi mới nội thất hay sang nhượng mặt bằng? <strong className="text-[#dc3545]">Đồ Cũ Huy Hoàng</strong> chuyên thu mua bàn ghế các loại với giá cao nhất thị trường tại TPHCM, Đồng Nai, Bình Dương và các tỉnh lân cận.
                </p>
              </div>
              ...
              <div className="relative w-full aspect-video rounded-2xl overflow-hidden mb-12 shadow-lg group">
                ...
                <Image
                  ...
                  alt="Dịch vụ thu mua bàn ghế gỗ cũ giá cao Huy Hoàng"
                  fill
                  priority
                ...
                <div className="absolute bottom-0 left-0 right-0 bg-black/60 text-white p-4 text-sm text-center">
                  Huy Hoàng chuyên thu mua bàn ghế gỗ gia đình, nhà hàng, quán cafe giá cao
                </div>
              </div>
              ...
              <section className="mb-12">
                <h3 className="text-2xl md:text-3xl font-black text-[#111827] uppercase tracking-tight mb-8 flex items-center gap-3">
                  ...
                  Lý Do Nên Chọn Dịch Vụ Tại Đồ Cũ Huy Hoàng
                </h3>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  {[
                    ...
                    <div key={i} className="flex gap-4 p-5 rounded-2xl bg-gray-50 border border-gray-100 hover:border-[#dc3545]/30 hover:bg-white transition-all duration-300 group">
                      <div className="w-10 h-10 rounded-full bg-[#dc3545]/10 flex items-center justify-center flex-shrink-0 text-[#dc3545] group-hover:bg-[#dc3545] group-hover:text-white transition-colors">
              ...
              <section className="mb-12">
                ...
                <div className="space-y-8">
                  ...
                  {/* Khối 1: Gia Đình */}
                  <div className="bg-white border-2 border-gray-100 rounded-3xl p-6 md:p-8 hover:border-[#dc3545]/30 transition-colors shadow-sm">
                    ...
                    <ul className="space-y-4 text-gray-700">
                      <li className="flex gap-3 items-start"><span className="text-[#dc3545] mt-1 flex-shrink-0">🔹</span> <p><strong className="text-[#111827]">Bàn ghế phòng khách (salon gỗ):</strong> Đây là dòng sản phẩm được thu mua nhiều nhất, bao gồm các bộ bàn ghế gỗ tự nhiên, gỗ công nghiệp với nhiều kiểu dáng từ truyền thống đến hiện đại.</p></li>
                      <li className="flex gap-3 items-start"><span className="text-[#dc3545] mt-1 flex-shrink-0">🔹</span> <p><strong className="text-[#111827]">Bàn ghế ăn gia đình:</strong> Bộ bàn ăn gỗ 4 ghế, 6 ghế hoặc nhiều hơn, thường được làm từ gỗ tự nhiên hoặc gỗ công nghiệp cao cấp.</p></li>
                      <li className="flex gap-3 items-start"><span className="text-[#dc3545] mt-1 flex-shrink-0">🔹</span> <p><strong className="text-[#111827]">Bộ bàn ghế nhỏ:</strong> Bàn trà, bàn uống nước, ghế thư giãn trong gia đình.</p></li>
                    </ul>
                  </div>
                  ...
                  <div className="bg-white border-2 border-gray-100 rounded-3xl p-6 md:p-8 hover:border-[#dc3545]/30 transition-colors shadow-sm">
                    <div className="flex items-center gap-4 mb-6 border-b border-gray-100 pb-4">
                      <div className="w-14 h-14 bg-[#dc3545] text-white rounded-2xl flex items-center justify-center">
                    ...
                    <ul className="space-y-4 text-gray-700">
                      <li className="flex gap-3 items-start"><span className="text-[#dc3545] mt-1 flex-shrink-0">🔹</span> <p><strong className="text-[#111827]">Bàn ghế quán cafe, trà sữa:</strong> Gồm bàn ghế gỗ công nghiệp, ghế giả mây, bàn mặt kính khung gỗ... thu mua với số lượng lớn.</p></li>
                      <li className="flex gap-3 items-start"><span className="text-[#dc3545] mt-1 flex-shrink-0">🔹</span> <p><strong className="text-[#111827]">Bàn ghế nhà hàng, quán ăn, quán nhậu:</strong> Thường là bàn ghế gỗ chắc chắn, chịu lực tốt, có độ bền cao do tần suất sử dụng nhiều.</p></li>
                      <li className="flex gap-3 items-start"><span className="text-[#dc3545] mt-1 flex-shrink-0">🔹</span> <p><strong className="text-[#111827]">Bàn ghế khách sạn, resort:</strong> Các bộ bàn ghế gỗ cao cấp, kiểu dáng sang trọng.</p></li>
                    </ul>
                  </div>
                  ...
                  <div className="bg-white border-2 border-gray-100 rounded-3xl p-6 md:p-8 hover:border-[#dc3545]/30 transition-colors shadow-sm">
                    ...
                    <ul className="space-y-4 text-gray-700">
                      <li className="flex gap-3 items-start"><span className="text-[#dc3545] mt-1 flex-shrink-0">🔹</span> <p><strong className="text-[#111827]">Bàn ghế giám đốc:</strong> Bàn làm việc và ghế xoay bọc da/nỉ, khung gỗ tự nhiên.</p></li>
                      <li className="flex gap-3 items-start"><span className="text-[#dc3545] mt-1 flex-shrink-0">🔹</span> <p><strong className="text-[#111827]">Bàn ghế nhân viên:</strong> Bàn làm việc gỗ công nghiệp, ghế xoay văn phòng.</p></li>
                      <li className="flex gap-3 items-start"><span className="text-[#dc3545] mt-1 flex-shrink-0">🔹</span> <p><strong className="text-[#111827]">Bàn ghế phòng họp:</strong> Bàn họp dài, ghế hội thảo khung gỗ.</p></li>
                    </ul>
                  </div>
              ...
              <section className="mb-12 bg-gray-50 p-6 md:p-8 rounded-3xl border border-gray-100 relative overflow-hidden">
                ...
                <p className="text-gray-700 leading-relaxed mb-10 relative z-10">
                  Quy trình thu mua tại Đồ Cũ Huy Hoàng được thiết kế đơn giản, minh bạch và nhanh chóng để tiết kiệm tối đa thời gian cho khách hàng:
                </p>
                ...
                <div className="space-y-6 relative z-10">
                  {[
                    ...
                    <div key={i} className="flex gap-5 items-start group bg-white p-5 rounded-2xl shadow-sm border border-gray-100 hover:border-[#dc3545]/30 transition-all">
                      <div className="w-12 h-12 bg-[#dc3545]/10 text-[#dc3545] rounded-full flex items-center justify-center text-xl font-black flex-shrink-0 group-hover:bg-[#dc3545] group-hover:text-white transition-all duration-300">
                        {item.step}
                      </div>
                      <div>
              ...
              <div className="relative w-full aspect-[16/9] rounded-2xl overflow-hidden mb-12 shadow-lg group">
                ...
                <Image
                  ...
                  alt="Huy Hoàng hỗ trợ vận chuyển và tháo dỡ bàn ghế gỗ cũ miễn phí"
                  fill
                  className="object-cover group-hover:scale-105 transition-transform duration-700"
              ...
              <div className="mt-16 bg-[#111827] rounded-3xl p-8 md:p-12 text-center shadow-xl relative overflow-hidden">
                ...
                <div className="relative z-10">
                  ...
                  <p className="text-gray-300 text-lg mb-8 max-w-2xl mx-auto">Nếu bạn đang có nhu cầu thanh lý bàn ghế hay bất kỳ loại nội thất nào, đừng ngần ngại liên hệ với chúng tôi. Đồ Cũ Huy Hoàng luôn sẵn sàng phục vụ!</p>
                  ...
                  <p className="text-gray-400 mt-8 text-sm uppercase tracking-widest font-semibold"><span className="text-[#dc3545]">Khu vực hoạt động:</span> TPHCM, Đồng Nai, Bình Dương và lân cận</p>
                </div>
              </div>
